...
/**
 *
 *watermask("./uploads/c.jpg","logo.png",'rt', 60); 
 *
 */
function watermask1($destination,$waterpngfilename,$pos = 'rb',$transparent = 20){    
...
function watermask($groundImage,$waterPos=9,$waterImage='',$waterText='',$textFont=5,$textColor='#FF0000') 
{
	$isWaterImage = FALSE; 
